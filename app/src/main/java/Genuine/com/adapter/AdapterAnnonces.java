...
public class AdapterAnnonces extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<AjoutModel> items = new ArrayList<>();
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, AjoutModel obj, int pos);
    }

    public AdapterAnnonces(List<AjoutModel> items, Context context, String layout_style) {
        this.items = items;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (layout_style.equals("0")) {
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_annonce, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            final AjoutModel o = items.get(position);

...
public class SignUpProfessionnelActivity extends SignUpActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sign_up_professionnel);
        bind_views();
    ...
    EditText first_name_view, last_name_view, email_view, password_view, phone_number_view, address_view,Siret,Entreprise;
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        if (!queryDocumentSnapshots.isEmpty()) {
                            Toast.makeText(SignUpProfessionnelActivity.this,
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        if (login_user()) {
                                            ...
                                            Intent intent = new Intent(SignUpProfessionnelActivity.this, MainActivity.class);
                                            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                            SignUpProfessionnelActivity.this.startActivity(intent);
                                            return;
                                        } else {
                                            Toast.makeText(SignUpProfessionnelActivity.this, "" +
